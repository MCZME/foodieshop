...
import mczme.foodieshop.item.ShopInventoryPenItem;
...
public class ModItems {
    ...
    public static final Supplier<Item> SHOP_INVENTORY_PEN = registerItem("shop_inventory_pen",
            () -> new ShopInventoryPenItem(new Item.Properties().stacksTo(1)));
